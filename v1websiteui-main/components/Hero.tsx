        ...
        <div className="flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <p className={`text-xl mb-8 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
              Vexa uses advanced automation and AI to streamline patient recruitment for clinical trials, ensuring faster, more efficient, and HIPAA-compliant study enrollment.
            </p>
