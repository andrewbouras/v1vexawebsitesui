...
const features = [
  ...
  },
  {
    ...
    description: 'Provides researchers with a comprehensive overview of the recruitment process, improving workflow efficiency.',
    icon: Brain,
  },
  {
    name: 'Customization and Flexibility',
    description: 'Adapts to various study requirements and protocols, supporting the diverse needs of different research teams.',
    icon: Zap,
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 max-w-2xl text-xl text-muted-foreground mx-auto">
            Vexa Research combines cutting-edge technology with open principles to revolutionize patient recruitment for clinical studies.
          </p>
        </motion.div>
