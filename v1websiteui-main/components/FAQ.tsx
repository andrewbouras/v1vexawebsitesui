...
const faqs = [
  {
    ...
    answer: "Vexa's Patient Recruitment Automation System is a comprehensive platform designed to streamline and secure the recruitment process for clinical studies. It leverages open standards and promotes open data to enhance efficiency and compliance."
  },
  {
    question: "How does the system integrate with existing EHR systems?",
    answer: "Our system seamlessly integrates with existing Electronic Health Record (EHR) systems, utilizing predefined criteria to identify potential study participants and ensuring data interoperability through open standards."
  },
  {
  ...
  },
  {
    ...
    answer: "We are working on AI-driven recruitment optimization, expanded interoperability, patient-centric features, a global collaboration hub, real-time analytics, and exploring blockchain technology for secure data management."
  }
]
