...
export const metadata: Metadata = {
  title: 'Privacy Policy | Vexa',
  description: 'Privacy policy for Vexa app users.',
}
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <section className="mb-8">
        ...
        <p>
          Vexa ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our mobile application and website (collectively, the "Service").
        </p>
      </section>
