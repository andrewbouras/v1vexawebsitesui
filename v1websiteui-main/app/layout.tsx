...
export const metadata: Metadata = {
  ...
  description: 'Transform clinical trial recruitment with our HIPAA-compliant automation platform. Seamlessly integrate with EHR systems, automate participant screening, and accelerate medical research timelines.',
  icons: {
    icon: [
      {
