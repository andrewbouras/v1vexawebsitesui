      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <p className={`text-xl mb-8 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
              Vexa uses advanced automation techniques to streamline patient recruitment for clinical trials, ensuring faster, more efficient, and HIPAA-compliant study enrollment.
            </p>
        ...
        >
          <p className={`text-3xl font-bold ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>
            Over <span className={isDarkMode ? 'text-gray-300' : 'text-gray-700'}>{questionsGenerated.toLocaleString()}</span> patients matched to clinical trials
          </p>
          <Button 
            variant="default" 
            size="lg" 
