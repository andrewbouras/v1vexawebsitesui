...
export const metadata: Metadata = {
  title: 'Terms of Service | Vexa',
  description: 'Terms of Service for Vexa app users.',
}
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <section className="mb-8">
        ...
        <p>
          By accessing or using the Vexa mobile application and website (the "Service"), you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part of the terms, you may not access the Service.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside ml-4">
          ...
          <li>To impersonate or attempt to impersonate Vexa, a Vexa employee, another user, or any other person or entity.</li>
      ...
      <section className="mb-8">
        ...
        <p>
          The Service and its original content (excluding Content provided by users), features, and functionality are and will remain the exclusive property of Vexa and its licensors.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mt-2">
          Email: dhruv@vexaresearch.com<br />
        </p>
      </section>
    </div>
  )
