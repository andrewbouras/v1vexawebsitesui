        ...
        <div className="flex flex-col sm:flex-row justify-center gap-6 mb-10">
          <Link href="/about#features" passHref>
            <Button size="lg" className="group transition-all duration-300 ease-in-out transform hover:scale-105">
              <Monitor className="mr-2 h-5 w-5 group-hover:animate-pulse" /> Learn More
            </Button>
          </Link>
          <Link href="/about" passHref>
            <Button size="lg" className="group transition-all duration-300 ease-in-out transform hover:scale-105">
              <Download className="mr-2 h-5 w-5 group-hover:animate-pulse" /> Request Demo
            </Button>
          </Link>
        </div>
      </section>
